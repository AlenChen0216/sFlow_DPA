...
#define SFLOW_DEDICATED_DATA_CAPACITY 131072U
...
_Static_assert(SFLOW_DEDICATED_DATA_CAPACITY == 131072U,
	       "The dedicated-data table must contain 131,072 elements");
